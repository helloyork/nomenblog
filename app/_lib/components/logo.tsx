        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="104.603" height="23.07" viewBox="0 0 104.603 23.07" className={`${className} glow`}>
            <defs>
                <filter id="glow">
                    ...
                    <feFlood flood-color="lightblue" flood-opacity="1" result="glowColor" />
